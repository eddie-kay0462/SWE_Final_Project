    ...
    <main className="min-h-screen flex flex-col bg-[#f3f1ea]">
      ...
      <section id="benefits" className="py-16 md:py-32 bg-[#f3f1ea]">
        <div className="container px-4 max-w-7xl">
          <h2 className="text-3xl md:text-[52px] text-center font-medium mb-6 animate-appear opacity-0">
            Why choose CSOFT?
          </h2>
          <p className="text-lg md:text-2xl text-center text-[#000000]/70 max-w-3xl mx-auto mb-12 md:mb-20 animate-appear opacity-0 delay-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 mt-8 md:mt-16">
            <div className="bg-white p-6 md:p-10 rounded-xl shadow-sm animate-appear opacity-0 delay-200">
            ...
            <div className="bg-white p-6 md:p-10 rounded-xl shadow-sm animate-appear opacity-0 delay-300">
      ...
      <section className="py-16 md:py-32 bg-white">
        <div className="container px-4 max-w-7xl text-center">
          <h2 className="text-3xl md:text-[52px] font-medium mb-4 md:mb-6 animate-appear opacity-0">
            Ready to transform your career services?
          </h2>
          <p className="text-lg md:text-2xl text-[#000000]/70 max-w-3xl mx-auto mb-8 md:mb-10 animate-appear opacity-0 delay-100">
            Join CSOFT today and experience the future of career development management
          </p>
          <Link href="/auth/signup">
            <div className="inline-flex items-center bg-[#A91827] text-[#ffffff] rounded-[10px] hover:bg-[#A91827]/90 transition-colors w-full md:w-[227px] h-[49px] animate-appear opacity-0 delay-200 mx-auto">
