...
const ThemeToggle = () => {
  ...
  return (
    <button
      ...
      className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-neutral-200/50 dark:hover:bg-muted hover:shadow-sm"
    >
      {darkMode ? (
        <>
